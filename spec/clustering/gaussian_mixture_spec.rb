...
RSpec.describe Rumale::Clustering::GaussianMixture do
  let(:x_mlt) { Xumo::DFloat[*Marshal.load(File.read(__dir__ + '/../test_samples_three_clusters.dat'))] }
  let(:y_mlt) { Xumo::Int32[*Marshal.load(File.read(__dir__ + '/../test_labels_three_clusters.dat'))] - 1 }
