...
module Rumale
  module Preprocessing
    ...
    class LabelBinarizer
      ...
      #   @param y [Xumo::NArray/Array] (shape: [n_samples]) The labels to fit encoder.
      # @return [LabelBinarizer]
      def fit(y, _not_used = nil)
        y = y.to_a if y.is_a?(Xumo::NArray)
      ...
      #
      # @overload fit_transform(y) -> Xumo::DFloat
      #   @param y [Xumo::NArray/Array] (shape: [n_samples]) The labels to fit encoder.
      # @return [Xumo::Int32] (shape: [n_samples, n_classes]) The binarized labels.
      ...
      def transform(y)
        ...
        n_samples = y.size
        codes = Xumo::Int32.zeros(n_samples, n_classes) + @params[:neg_label]
